...
<asp:Content ID="userOverview" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView ID="gv" runat="server" AllowPaging="true" OnPageIndexChanging="gridView_PageIndexChanging" CssClass="table table-hover table-striped gridview" ></asp:GridView>
</asp:Content>
