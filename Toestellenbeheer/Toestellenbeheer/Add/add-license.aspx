    ...
    <body>
        ...
        <div id="hardwareGrides">
            ...
            <asp:Panel ID="hardwarePanel" CssClass="innerPopup" runat="server">
                ...
                DropShadow="False"
                CancelControlID="btnAssignToSelectedHardware">
                ...
                <asp:GridView ID="licenseOverviewGridSearch" OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="display_search_button" CssClass="table table-hover table-striped gridview" runat="server">
